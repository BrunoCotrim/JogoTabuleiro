...
pos_1 = [LARGURA / 2 - tamanho_botao[0] / 2 , ALTURA / 2 - tamanho_botao[1] / 2 + 50]
botao1 = pygame.Rect(pos_1, tamanho_botao)
...
textRect.center = ((pos_1[0] + tamanho_botao[0] / 2), (pos_1[1] + tamanho_botao[1] / 2))
display.blit(textSurf, textRect)
pos_2 = [LARGURA / 2 - tamanho_botao[0] / 2 , ALTURA / 2 - tamanho_botao[1] / 2 + 120]
botao2 = pygame.Rect(pos_2, tamanho_botao)
pygame.draw.rect(display, [36, 128, 20], botao2)
textobotao = pygame.font.Font('freesansbold.ttf', 18)
textSurf, textRect = text_botoes("Sair", textobotao)
textRect.center = ((pos_2[0] + tamanho_botao[0] / 2), (pos_2[1] + tamanho_botao[1] / 2))
display.blit(textSurf, textRect)
